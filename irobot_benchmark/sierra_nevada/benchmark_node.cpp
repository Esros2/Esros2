...
private:
    void timer_callback(const std_msgs::msg::Float32::SharedPtr msg) const
    {
        start_lyon = std::chrono::high_resolution_clock::now();
        auto duration = std::chrono::duration_cast<std::chrono::microseconds>(start_lyon - start_montreal);
...
public:
    mandalay() : Node("mandalay")
    {
        ...
        // Subscribers
        subscriptionA_ = this->create_subscription<std_msgs::msg::String>(
            "danube", 10, std::bind(&mandalay::topicA_callback, this, std::placeholders::_1));
...
private:
    ...
    void topicE_callback(const std_msgs::msg::String::SharedPtr msg) const
    {
        // RCLCPP_INFO(this->get_logger(), "Received message: '%s'", msg->data.c_str());
        // publisher1_->publish(*msg);
        // publisher3_->publish(*msg);
    ...
    void topicF_callback(const std_msgs::msg::Float32::SharedPtr msg) const
    {
        // start_mandalay = std::chrono::high_resolution_clock::now();
        // auto duration = std::chrono::duration_cast<std::chrono::microseconds>(start_mandalay - start_cordoba);
...
public:
    ponce() : Node("ponce")
    {
        ...
        subscriptionA_ = this->create_subscription<std_msgs::msg::String>(
            "danube", 10, std::bind(&ponce::topicA_callback, this, std::placeholders::_1));
        subscriptionB_ = this->create_subscription<std_msgs::msg::Float32>(
            "missouri", 10, std::bind(&ponce::topicB_callback, this, std::placeholders::_1));
    }
...
public:
    geneva() : Node("geneva")
    {
        ...
        subscriptionC_ = this->create_subscription<std_msgs::msg::String>(
            "congo", 10, std::bind(&geneva::topicC_callback, this, std::placeholders::_1));
    }
